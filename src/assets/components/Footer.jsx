...
export default function Footer() {
  ...
  const handleInsta = () =>
    (window.location.href = 'https://www.instagram.com/vetalamusic/')
  ...
  const handleSoundcloud = () =>
    (window.location.href = 'https://soundcloud.com/vvetala?ref=clipboard&p=i&c=1&si=92931BB8590640BAB07AFF14E8FFF45F&utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing')
